...
var art_task = {
  ...
  correct_text: '<div class = centerbox; size=small><div class = center-text>Please wait for the next trial</div></div>',
  incorrect_text: '<div class = centerbox; size=small><div class = center-text>Please wait for the next trial</div></div>'
};
