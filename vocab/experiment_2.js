...
//65 real from Acheson et al. 2008, 40 foil from Mar et al. 2006
//should check if there is a difference between British and US groups -- tested in a US undergrad pop
// less foils than the original: different population (not undergrads), many real items only had <10% amongst undergrads
...
var trials = [
    ...
    //REAL TRIALS START BELOW (WITH FICTION LIST)
    ["Lauren Adamson", 74],
    ["Eric Amsel", 74],
    ["Margarita Azmitia", 74],
    ["Oscar Barbarin", 74],
    ["Reuben Baron", 74],
    ["Gary Beauchamp", 74],
    ["Thomas Bever", 74],
    ...
    ["Gabriel Garcia Marquez", 70],
    ["Anne McCaffrey", 70],
    ["Margaret Mitchell", 70],
    ["Vladimir Nabokov", 70],
    ["Joyce Carol Oates", 70],
    ["Michael Ondaatje", 70],
    ["George Orwell", 70],
    ["James Patterson", 70],
    ["Thomas Pynchon", 70],
...
var art_task = {
  ...
  correct_text: '<div class = centerbox><div class = center-text>+</div></div>',
  incorrect_text: '<div class = centerbox><div class = center-text>+</div></div>'
};
