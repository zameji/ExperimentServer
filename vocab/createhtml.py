...
for list in words:
    ...
    correct += "<label for='vocab_" + str(q_number) + "'>" + list[1] + "</label><br />"
    ...
    incorrect_1 += "<label for='vocab_" + str(q_number) + "'>" + list[2] + "</label><br />"
    ...
    incorrect_2 += "<label for='vocab_" + str(q_number) + "'>" + list[3] + "</label><br />"
    ...
    incorrect_3 += "<label for='vocab_" + str(q_number) + "'>" + list[4] + "</label><br />"
