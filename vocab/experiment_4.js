...
var instructions_block = {
  ...
  '<p class = block-text>Important! Please be sure to have and keep all other browser windows closed while doing this task.</p></div>'+
  '<p class = block-text>Our algorithim is very sensitive and may flag your responses as being suspcious if other tabs, windows, or programs are open.</p></div>'
  ],
  allow_keys: false,
  data: {
    exp_id: "vocab_timed4",
