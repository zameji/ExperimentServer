...
for (b = 0; b < blocks_list.length; b++) {
	...
	task.stimulus = '<div class = centerbox><div class =  center-block-text>' + cue + '</div>' +
						'<div class =  center-block-text> <b>F.</b> ' + f_choice + '</div>' +
						'<div class =  center-block-text> <b>G.</b> ' + g_choice + '</div>' +
						'<div class =  center-block-text> <b>H.</b> ' + h_choice + '</div>' +
						'<div class =  center-block-text> <b>J.</b> ' + j_choice + '</div>' +
					'</div>'
