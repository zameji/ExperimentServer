...
var instructions_block = {
  ...
  pages: [
    ...
    ' after every letter.</b> This means that you have to press a key after every letter! </p><p class = block-text>Important: Do not press any keys before you see a letter. If you press a key before the letter is shown, you will lose a point for this section.</div>',
