...
var instructions_block = {
  ...
  pages: [
    '<div class = centerbox><p class = block-text>In this task, you will see a red letter, followed by multiple black letters, and finally, another red letter. Then, a new set will start.</p><p class = block-text>Your job is to respond by pressing the "J" key after all letters EXCEPT if the first red letter in the set was an "A" and  the second red letter was an "X".<b> If the first red letter was an "A" <strong>AND</strong> the current letter is a red "X", press the ' +
    possible_responses[0][0] + '. Otherwise press the ' + possible_responses[1][0] +
    ' after every letter.</b> This means that you have to press a key after every letter! </p><p>After the second red letter, you will be told to press any key to continue and another set of letters will come -- this will repeat many times.</p><p class = block-text>Important: Do not press any keys before you see a letter. If you press a key before the letter is shown, you will lose a point for this section.</div>',
...
var wait_block = {
  ...
  stimulus: '<div class = centerbox><div class = AX_feedback>Press any key to continue.</div></div>',
  is_html: true,
  data: {
    trial_id: "wait"
  },
