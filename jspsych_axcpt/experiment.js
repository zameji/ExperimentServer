...
var start_test_block = {
  ...
  text: '<div class = centerbox><p class = center-block-text>We will now start the test. Remember, press J after every letter unless the first red letter was an A and the current letter is a red X.</p><p class = center-block-text> This task will take 5-7min.</div>',
  cont_key: [13],
