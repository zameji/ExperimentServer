...
class _document_MyDocument extends document_default.a {
  ...
  render() {
    return __jsx(next_document["Html"], {
      ...
      name: "description",
      content: "Webapp for big five personality test"
    }), __jsx("title", null, "Big five webapp")), __jsx("body", null, __jsx(next_document["Main"], null), __jsx(next_document["NextScript"], null)));
  }
