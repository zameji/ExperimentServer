...
["Exp2_ListA_firstPair", "AudioDisplay", {transfer: "keypress", normalMessage: "Memorize this image, then press any key to continue.", url: "https://www.psycholinguistics.ml/ibex_2/audio/4F_d.mp3"}, "DashedSentence", {s: "Because of the dense fog, Addy could barely see where she was going."}, "Question", {q: "Was it foggy weather that made it difficult to Addy to see where she was going?", as:["yes", "no"]}],
["Exp2_ListA_secondPair", "PictureDisplay", {transfer: "keypress", normalMessage: "Memorize these words, then press any key to continue.", url: "https://www.psycholinguistics.ml/ibex_2/img/4_s.png"}, "DashedSentence", {s: "Through the dense woods, the porch light lit the way."}, "Question", {q: "Was it a flashlight that was lighting the way?", as:["no", "yes"]}],
...
["Exp2_ListA_firstPair", "AudioDisplay", {transfer: "keypress", normalMessage: "Memorize this image, then press any key to continue.", url: "https://www.psycholinguistics.ml/ibex_2/audio/5M_d.mp3"}, "DashedSentence", {s: "The show focused on the distinct cultures that are found around the world."}, "Question", {q: "Was the show about recent medical discoveries?", as:["no", "yes"]}],
...
["Exp2_ListA_secondPair", "PictureDisplay", {transfer: "keypress", normalMessage: "Memorize these words, then press any key to continue.", url: "https://www.psycholinguistics.ml/ibex_2/img/8A_d.png"}, "DashedSentence", {s: "On account of the enormous potential of the new proposal, we will definitely accept it."}, "Question", {q: "Will the proposal be accepted?", as:["yes", "no"]}],
