...
jsPsych.plugins["multi-stim-multi-response-mouse"] = (function() {

  var plugin = {};

  jsPsych.pluginAPI.registerPreload('multi-stim-multi-response-mouse', 'stimuli', 'image');
  ...
  plugin.trial = function(display_element, trial) {
    ...
    trial.usemouse = trial.usemouse || false; // if using mouse or keyboard. default is keyboard
