...
var instructions_block = {
  ...
  pages: [
    '<div class = centerbox><p class = block-text>In this experiment you will see blue or black shapes made up of smaller shapes, like the image below. <br><br> Both the large shape and the smaller shapes can either be a circle, X, triangle or square.<br><br> The small shapes will always be the same, but they may be different to the big shape.</p><br><div class = instructionImgBox><br><br><img src = "images/blue_squareofcircles.png" height = 200 width = 200></img></div></div>',
